...
{
    [TestFixture]
    public class When_an_InventoryItem_with_insufficient_stock_is_checked_out_of_stock : AggregateRootTestFixture<InventoryItem>
    {
        ...
        protected override IEnumerable<Event> Given()
        {
            ...
            yield return new InventoryItemReceivedIntoStock(_inventoryItemId, 3);
        }
